...
Route::get('/', 'frontend@home')->name('frontend.home.index');
Route::get('/beasiswa', 'frontend@beasiswa')->name('frontend.beasiswa.index');
Route::get('/about', 'frontend@about')->name('frontend.about.index');
